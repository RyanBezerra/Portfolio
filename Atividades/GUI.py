...
class App(TKMT.ThemedTKinterFrame):
    ...
    def textupdate(self, _var, _indx, _mode):
        ...
        if self.checkbox1.get() == True:
            ...
            if self.optionmenuvar.get() == "Triângulo":
                base_str = self.textinputvara.get()
                altura_str = self.textinputvar2a.get()
            ...
            if self.optionmenuvar.get() == "Quadrado":
                lado_str = self.textinputvara.get()
            ...
            if self.optionmenuvar.get() == "Retângulo":
                altura_str = self.textinputvara.get()
                base_str = self.textinputvar2a.get()
            ...
            if self.optionmenuvar.get() == "Losango":
                diagonalmaior_str = self.textinputvara.get()
                diagonalmenor_str = self.textinputvar2a.get()
            ...
            if self.optionmenuvar.get() == "Trapézio":
                basemaior_str = self.textinputvara.get()
                basemenor_str = self.textinputvar2a.get()
                altura_str = self.textinputvar3a.get()
            ...
            if self.optionmenuvar.get() == "Círculo":
                raio_str = self.textinputvara.get()
    ...
    def handleButtonClick(self):
        ...
        if self.checkbox1.get() == True:
            ...
            if self.optionmenuvar.get() == "Triângulo":
                ...
                self.textinputvara = tk.StringVar()
                self.textinputvara.trace_add('write', self.textupdate)
                delete_entry2.append(self.input_frame4.Entry(self.textinputvara))
                self.textinputvar2a = tk.StringVar()
                self.textinputvar2a.trace_add('write', self.textupdate)
                delete_entry2.append(self.input_frame4.Entry(self.textinputvar2a))
            ...
            if self.optionmenuvar.get() == "Trapézio":
                ...
                self.textinputvar2a.trace_add('write', self.textupdate)
                delete_entry2.append(self.input_frame4.Entry(self.textinputvar2a))
                self.textinputvar3a = tk.StringVar()
                self.textinputvar3a.trace_add('write', self.textupdate)
                delete_entry2.append(self.input_frame4.Entry(self.textinputvar3a))
    ...
    def __init__(self):
        ...
        self.checkbox2a = self.input_frame.Checkbutton("Perímetro", self.checkbox2)
        self.checkbox1a = self.input_frame.Checkbutton("Área", self.checkbox1)
